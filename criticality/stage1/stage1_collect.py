...
def main(args):
    ...
    for ep in range(args.n):
        ...
        cube_actor = base_env.cube  # PickCube: 方块
        ...
        while not done:
            ...
            # PickCube: 从 fx, fy, fz 三个维度各自独立离散采样
            ...
            # PickCube should provide info["success"] each step
...
if __name__ == "__main__":
    ...
    # env / model
    p.add_argument("--env_id", type=str, default="PickCube-v1")
    p.add_argument("--checkpoint", type=str, default='examples/baselines/ppo/runs/PickCube-v1__ppo__1__1780321332/final_ckpt.pt')
    ...
    p.add_argument("--force_mag", type=float, default=2.0)     # like wind_power
